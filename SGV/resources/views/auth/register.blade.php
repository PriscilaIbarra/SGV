            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="contraseña" class="col-md-4 col-form-label text-md-right">{{ __('Contraeña') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="confirmar-contraseña" class="col-md-4 col-form-label text-md-right">{{ __('Confirmar contraseña') }}</label>
